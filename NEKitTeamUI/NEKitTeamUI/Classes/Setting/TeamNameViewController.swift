    ...
    func setupUI(){
        ...
        if #available(iOS 11.0, *) {
            NSLayoutConstraint.activate([
                ...
                backView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 12),
...
//                disableSubmit()
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textFieldChange), name: UITextField.textDidChangeNotification, object: textField)
...
extension TeamNameViewController: UITextFieldDelegate {
    ...
    @objc func textFieldChange() {
        if var text = textField.text {
            if let lang = textField.textInputMode?.primaryLanguage, lang == "zh-Hans", let selectRange = textField.markedTextRange {
