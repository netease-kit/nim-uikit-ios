...
- (NSArray *)loadChartletEmoticonCatalog{
    ...
    NSURL *url = [[NSBundle mainBundle] URLForResource:[[NIMKit sharedKit] bundleName]
                                         withExtension:nil];
                             ...
                             emoticons:(NSArray *)emoticonsArray
{
    ...
    NSString *iconNamePrefix = [[[[NIMKit sharedKit] bundleName] stringByAppendingPathComponent:NIMKit_EmoticonPath] stringByAppendingPathComponent:NIMKit_EmojiPath];
    ...
    for (NSDictionary *emoticonDict in emoticonsArray) {
        ...
        NSString *imageNamePrefix = [[[[NIMKit sharedKit] bundleName] stringByAppendingPathComponent:NIMKit_EmoticonPath] stringByAppendingPathComponent:NIMKit_EmojiPath];
