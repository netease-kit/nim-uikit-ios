...
@interface NIMIndefiniteAnimatedView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation NIMIndefiniteAnimatedView
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        NSString *path = [imageBundle pathForResource:@"hud_angle_mask" ofType:@"png"];
