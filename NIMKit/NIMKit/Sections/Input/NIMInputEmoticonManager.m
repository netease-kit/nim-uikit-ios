                             ...
                             emoticons:(NSArray *)emoticonsArray
{
    ...
    NSString *iconNamePrefix = [[[NIMKit sharedKit] emoticonBundleName] stringByAppendingPathComponent:NIMKit_EmojiPath];
    ...
    for (NSDictionary *emoticonDict in emoticonsArray) {
        ...
        NSString *imageNamePrefix = [[[NIMKit sharedKit] emoticonBundleName] stringByAppendingPathComponent:NIMKit_EmojiPath];
