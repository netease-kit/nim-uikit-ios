    ...
    func setupUI(){
        ...
        if #available(iOS 11.0, *) {
            NSLayoutConstraint.activate([
                headerBack.topAnchor.constraint(equalTo:view.safeAreaLayoutGuide.topAnchor, constant: 12.0),
        ...
        NSLayoutConstraint.activate([
            ...
            defaultHeaderBack.topAnchor.constraint(equalTo: headerBack.bottomAnchor, constant: 12.0),
        ...
        iconCollection.register(TeamDefaultIconCell.self, forCellWithReuseIdentifier: "\(TeamDefaultIconCell.self)")
        NSLayoutConstraint.activate([
            iconCollection.topAnchor.constraint(equalTo: tag.bottomAnchor, constant: 16.0),
            iconCollection.leftAnchor.constraint(equalTo: defaultHeaderBack.leftAnchor, constant: 18),
            iconCollection.rightAnchor.constraint(equalTo: defaultHeaderBack.rightAnchor, constant: -18.0),
...
extension TeamAvatarViewController: UINavigationControllerDelegate {
