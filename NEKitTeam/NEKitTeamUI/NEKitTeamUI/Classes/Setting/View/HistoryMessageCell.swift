...
class HistoryMessageCell: UITableViewCell {
    ...
    func setupSubviews(){
        ...
        NSLayoutConstraint.activate([
            ...
            headImge.centerYAnchor.constraint(equalTo: self.contentView.centerYAnchor,constant: -5),
        ...
        NSLayoutConstraint.activate([
            ...
            title.rightAnchor.constraint(equalTo: self.contentView.rightAnchor,constant: -20),
        ...
        NSLayoutConstraint.activate([
            bottomLine.rightAnchor.constraint(equalTo: self.contentView.rightAnchor),
