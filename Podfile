...
#  pod 'NEContactUIKit', '9.2.2'
#  pod 'NEQChatUIKit', '9.2.2'
#  pod 'NEConversationUIKit', '9.2.2'
#  pod 'NEChatUIKit', '9.2.2'
#  pod 'NETeamUIKit', '9.2.2'
  
  # 如果需要查看UI部分源码请注释掉以上在线依赖，打开下面的本地依赖
  pod 'NEChatKit', '9.2.2'
  pod 'NEConversationKit', '9.2.2'
  pod 'NEContactKit', '9.2.2'
  pod 'NETeamKit', '9.2.2'
