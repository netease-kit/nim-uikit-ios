...
class EditMemberViewModel  {
    ...
    func updateMyMember(_ serverId: UInt64?, _ nick: String?,  _ completion: @escaping (Error?, ServerMemeber) -> Void){
    ...
    func updateMember(_ serverId: UInt64?, _ nick: String?, _ accid: String?,  _ completion: @escaping (Error?, ServerMemeber) -> Void){
    ...
    func kickoutMember(_ serverId: UInt64?, _ accid: String?, _ completion: @escaping (Error?)->Void){
    ...
    func addMembers(_ accid: String?, _ serverId: UInt64?, _ roleId: UInt64?, _ completion: @escaping () -> Void){
    ...
    func remove(_ accid: String?, _ serverId: UInt64?, _ rid: UInt64?, _ completion: @escaping () -> Void){
