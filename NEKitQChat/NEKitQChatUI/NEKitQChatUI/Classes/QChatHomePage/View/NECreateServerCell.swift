...
class NECreateServerCell: UITableViewCell {
    ...
    var model:(image:String,title:String)? {
        didSet {
            self.headImageView.image = UIImage.ne_imageNamed(name: model?.image)
    ...
    func setupSubviews() {
        ...
        NSLayoutConstraint.activate([
            ...
            serviceBgView.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 8),
            serviceBgView.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -8),
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            arrowImageView.rightAnchor.constraint(equalTo: serviceBgView.rightAnchor, constant: -kScreenInterval),
    ...
    private lazy var arrowImageView:UIImageView = {
        let imageView = UIImageView.init(image: UIImage.ne_imageNamed(name: "arrowRight"))
        imageView.translatesAutoresizingMaskIntoConstraints = false
        return imageView
    }()
