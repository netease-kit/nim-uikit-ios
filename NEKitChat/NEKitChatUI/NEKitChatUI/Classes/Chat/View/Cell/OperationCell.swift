...
//    public weak var delegate: OperationCellDelegate?
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            imageView.centerXAnchor.constraint(equalTo: self.contentView.centerXAnchor, constant: 0),
            imageView.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 8),
        ...
        NSLayoutConstraint.activate([
            ...
            label.leftAnchor.constraint(equalTo: self.contentView.leftAnchor, constant: 0),
            label.rightAnchor.constraint(equalTo: self.contentView.rightAnchor, constant: 0),
