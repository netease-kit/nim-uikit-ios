...
class ChatReplyRightCell: ChatBaseRightCell {
    ...
    func commonUI() {
        ...
        NSLayoutConstraint.activate([
            self.textView.rightAnchor.constraint(equalTo: bubbleImage.rightAnchor, constant: 0),
            self.textView.leftAnchor.constraint(equalTo: bubbleImage.leftAnchor, constant: 8),
            self.textView.topAnchor.constraint(equalTo: replyLabel.bottomAnchor, constant: -qChat_margin),
            self.textView.bottomAnchor.constraint(equalTo: bubbleImage.bottomAnchor, constant: -qChat_margin)
        ])
    }
