...
public final class NEImageAsset: NEAsset {
  // MARK: Lifecycle

  required init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: NEImageAsset.NECodingKeys.self)
  ...
  required init(dictionary: [String: Any]) throws {
    ...
    directory = try dictionary.value(for: NECodingKeys.directory)
...
extension Data {
  ...
  /// Initializes `Data` from an `NEImageAsset`.
  ///
