...
///
protocol NENodeOutput {
  /// The parent node.
  var parent: NENodeOutput? { get }
...
///
protocol NEAnimatorNode: AnyObject, NEKeypathSearchable {
  ...
  /// property system.
  ///
  var propertyMap: NENodePropertyMap & NEKeypathSearchable { get }

  /// The upstream input node
  var parentNode: NEAnimatorNode? { get }

  /// The output of the node.
  var outputNode: NENodeOutput { get }
