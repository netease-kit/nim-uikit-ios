...
public class ForwardAlertViewController: UIViewController {
    ...
    public func setupUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            userCollection.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -16.0),
        ...
        userCollection.register(ForwardUserCell.self, forCellWithReuseIdentifier: "\(ForwardUserCell.self)")
...
extension ForwardAlertViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "\(ForwardUserCell.self)", for: indexPath) as? ForwardUserCell {
    ...
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: 32.0, height: 32)
    }
