...
public extension UIColor {
  static let funChatInputBg = UIColor(hexString: "#F5F5F5")
  static let funChatInputReplyBg = UIColor(hexString: "#E1E1E1")
  ...
  static let funChatInputMoreActionViewLineColor = UIColor(hexString: "#DDDDDD")
  ...
  static let funChatInputViewPlaceholderTextColor = UIColor(hexString: "#AAAAAA")
