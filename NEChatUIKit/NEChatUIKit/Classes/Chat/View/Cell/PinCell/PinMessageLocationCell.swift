...
class PinMessageLocationCell: PinMessageBaseCell {
  ...
  override func setupUI() {
    ...
    contentWidth = back.widthAnchor.constraint(equalToConstant: 0)
    contentHeight = back.heightAnchor.constraint(equalToConstant: 0)
