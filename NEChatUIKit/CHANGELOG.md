...
## 10.9.60(2026-09-21)
### New Features
* 支持最早未读消息定位、群成员搜索定位和贴图表情。

### Behavior changes
* 统一输入框换行规则，优化消息刷新、图片预览和历史引用交互。
* 完善 Reaction、语音转文字、收藏转发和多选阅读的布局与状态处理。

### Bug Fixes
* 修复消息列表行数不一致崩溃、邀请通知重复和快捷回复未实时显示问题。
* 修复图片预览键盘、新消息提醒、Reaction 复用及搜索结果展示问题。
