...
@objcMembers
open class FunCollectionMessageMultiForwardCell: NEBaseCollectionMessageMultiForwardCell {
  ...
  override open func setupCommonUI() {
    ...
    NSLayoutConstraint.activate([
      titleLabelLeft1.leftAnchor.constraint(equalTo: backImageViewLeft.leftAnchor, constant: 12 + funMargin),
      titleLabelLeft1.rightAnchor.constraint(lessThanOrEqualTo: backImageViewLeft.rightAnchor, constant: -102),
      titleLabelLeft1.topAnchor.constraint(equalTo: backImageViewLeft.topAnchor, constant: 12),
