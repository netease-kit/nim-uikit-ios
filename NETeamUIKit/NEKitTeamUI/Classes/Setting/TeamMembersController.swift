...
//        table.bounces = false
    ...
    func setupUI(){
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textChange), name: UITextField.textDidChangeNotification, object: nil)
    }
...
extension TeamMembersController: UITableViewDelegate, UITableViewDataSource {
