...
class ConversationSearchCell: TextBaseCell {
    ...
    public var searchText:String = "" {
        didSet {
            if let titleText = titleLabel.text,let range = titleText.findAllIndex(searchText).first {
