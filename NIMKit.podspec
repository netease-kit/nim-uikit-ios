Pod::Spec.new do |s| 
  ...
  s.source  = { :git => 'https://github.com/netease-im/NIM_iOS_UIKit.git', :tag => '2.11.1'}  
  s.platform = :ios, '8.0' 
  ...
  s.subspec 'Full' do |cs|	
    ...
    cs.dependency 'NIMSDK', '~> 5.7.0' 
  end 

  s.subspec 'Lite' do |cs|  
    cs.source_files = 'NIMKit/NIMKit/**/*.{h,m}'  
    cs.dependency 'NIMKit/Core'  
    cs.dependency 'NIMSDK_LITE', '~> 5.7.0'  
  end  
  ...
  s.subspec 'Core' do |os|     
    ...
    os.dependency 'TZImagePickerController', '~> 3.0.9'  
  end   
