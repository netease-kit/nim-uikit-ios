...
@objcMembers
open class FunLocalConversationSearchController: NEBaseLocalConversationSearchController {
  /// 取消按钮
  ...
  override public init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
    ...
    tag = "FunLocalConversationSearchController"
  }
  ...
  override open func setupSubviews() {
    ...
    tableView.register(
      FunLocalConversationSearchCell.self,
      forCellReuseIdentifier: "\(NSStringFromClass(NEBaseLocalConversationSearchCell.self))"
    )
    tableView.register(
