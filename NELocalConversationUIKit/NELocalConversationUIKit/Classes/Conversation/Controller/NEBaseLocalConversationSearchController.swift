...
@objcMembers
open class NEBaseLocalConversationSearchController: NELocalConversationBaseViewController, UITableViewDelegate,
  UITableViewDataSource {
  var viewModel = LocalConversationSearchViewModel()
  var tag = "LocalConversationSearchBaseController"
  var searchStr = ""
  ...
  open func tableView(_ tableView: UITableView,
    ...
    if let cell = tableView.dequeueReusableCell(
      withIdentifier: "\(NSStringFromClass(NEBaseLocalConversationSearchCell.self))",
      for: indexPath
    ) as? NEBaseLocalConversationSearchCell {
    ...
    return NEBaseLocalConversationListCell()
  }
