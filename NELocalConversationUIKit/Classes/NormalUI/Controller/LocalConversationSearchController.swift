...
@objcMembers
open class LocalConversationSearchController: NEBaseLocalConversationSearchController {
  override public init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
    super.init(nibName: nibNameOrNil, bundle: nibBundleOrNil)
    tag = "LocalConversationSearchController"
  }
  ...
  override open func setupSubviews() {
    ...
    tableView.register(
      LocalConversationSearchCell.self,
