...
// MARK: - NECurveVertex + NEInterpolatable

extension NECurveVertex: NEInterpolatable {
  func interpolate(to: NECurveVertex, amount: CGFloat) -> NECurveVertex {
    NECurveVertex(
...
// MARK: - NEBezierPath + NEInterpolatable

extension NEBezierPath: NEInterpolatable {
  func interpolate(to: NEBezierPath, amount: CGFloat) -> NEBezierPath {
    var newPath = NEBezierPath()
...
// MARK: - NETextDocument + NEInterpolatable

extension NETextDocument: NEInterpolatable {
  func interpolate(to: NETextDocument, amount: CGFloat) -> NETextDocument {
    if amount == 1 {
      return to
    }
    return self
