...
// MARK: - NEKeyframeInterpolator

/// A value provider that produces a value at Time from a group of keyframes
final class NEKeyframeInterpolator<ValueType>: NEValueProvider where ValueType: NEAnyInterpolatable {
  // MARK: Lifecycle

  init(keyframes: ContiguousArray<NEKeyframe<ValueType>>) {
    self.keyframes = keyframes
  }

  // MARK: Internal

  let keyframes: ContiguousArray<NEKeyframe<ValueType>>
