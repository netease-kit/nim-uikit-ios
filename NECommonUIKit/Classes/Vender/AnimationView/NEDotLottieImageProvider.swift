...
// MARK: - NEDotLottieImageProvider

/// An image provider that loads the images from a NEDotLottieFile into memory
class NEDotLottieImageProvider: NEAnimationImageProvider {
  // MARK: Lifecycle
...
extension NEDotLottieImageProvider: Hashable {
  static func == (_ lhs: NEDotLottieImageProvider, _ rhs: NEDotLottieImageProvider) -> Bool {
