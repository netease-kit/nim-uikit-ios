...
final class NEShapeRenderLayer: NEShapeContainerLayer {
  // MARK: Lifecycle

  init(renderer: NERenderable & NENodeOutput) {
  ...
  override init(layer: Any) {
    guard let layer = layer as? NEShapeRenderLayer else {
  ...
  fileprivate(set) var renderer: NERenderable & NENodeOutput
