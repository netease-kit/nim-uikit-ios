...
@objcMembers
public class MemberManagerViewModel: NSObject {
  var datas = [UserInfo]()
  ...
  private let className = "MemberManagerViewModel"
  ...
  func addMembers(_ users: [UserInfo], _ serverId: UInt64?, _ roleId: UInt64?,
...
//                weakSelf?.delegate?.dataDidChange()
  ...
  func remove(_ user: UserInfo, _ serverId: UInt64?, _ rid: UInt64?,
