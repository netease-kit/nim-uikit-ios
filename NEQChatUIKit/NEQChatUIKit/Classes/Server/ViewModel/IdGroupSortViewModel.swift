...
@objcMembers
public class IdGroupSortViewModel: NSObject {
  let repo = QChatRepo()
...
//    var lockData = [IdGroupModel]()
  ...
  private let className = "IdGroupSortViewModel"
...
//            }
  ...
  func removeRole(_ serverId: UInt64?, _ roleId: UInt64?, _ model: IdGroupModel,
