...
class ChannelHeaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            prefixLabel.topAnchor.constraint(equalTo: self.topAnchor, constant: 20),
            prefixLabel.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 20),
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -81),
        ...
        NSLayoutConstraint.activate([
            settingButton.topAnchor.constraint(equalTo: self.topAnchor, constant: 10),
            settingButton.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -16),
